...
\begin{titlepage}
  ...
  \begin{tcolorbox}[colback=lightblue, colframe=primary, arc=6pt,
                    title={\bfseries Duas solu\c{c}\~oes desenvolvidas e comparadas}]
    \begin{tabular}{ll}
...
%% --- Metricas de treinamento YOLO ---
\subsection{M\'etricas do Treinamento -- Curvas e Evolu\c{c}\~ao}

A seguir s\~ao apresentadas as curvas de treinamento geradas automaticamente pelo
Ultralytics ao longo das 100 \'epocas do modelo selecionado
